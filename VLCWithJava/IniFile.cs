...
{
    partial class IniFile   // revision 11
    {
        private readonly string _path;
        private readonly string _exe = Assembly.GetExecutingAssembly().GetName().Name ?? throw new InvalidOperationException();

        [LibraryImport("kernel32", EntryPoint = "WritePrivateProfileString", SetLastError = true, StringMarshalling = StringMarshalling.Utf16)]
